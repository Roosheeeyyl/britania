...
export default function Viform() {
  const [id, setID] = useState('');
    ...
    const Print = () => {
      ...
      const updateField = (x) => {
        let fieldToEdit = doc(databaseReference, id);
    ...
    return (
        ...
        <div className=' w-auto flex flex-col justify-center place-items-center min-h-screen py-5 relative'>
            <div className='right-10 left-16 '>
        <div 
        ...
        <table className="w-auto h-auto mr-52 ml-52 py-10 text-sm text-center text-black dark:text-black">
              <thead className="w-auto h-auto mr-52 ml-52 py-10 text-lg text-black uppercase bg-black dark:bg-black dark:text-white">
                                 ...
                                 {fireData.map((data) => {
                                        return (
                                                ...
                                                <tr className="border-b " key={data.id}>
                                                    ...
                                                    <td className="text-lg text-black bg-black dark:bg-emerald-200 font-medium px-6 py-4 whitespace-nowrap">  
                                                    <button type='Delete'
                    ...
                    sm:w-auto px-6 py-2.5 text-center
                     dark:bg-blue-500 dark:hover:bg-blue-900
                      dark:focus:ring-blue-500 print:hidden
                       right-10"
                 onClick={() => handleEdit(data)}>Edit</button></td>
